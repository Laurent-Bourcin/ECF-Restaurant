...
<head>
    ...
    <title>ECF_Restaurant_Admin_Jour_Supprimer</title>
</head>
...
<section class="container-fluid mb-5">
    <form action="day_remove_process.php" method="post">
        <!-- Remove day -->
        <div class="row mb-3 text-center">
            <div class="col-6 text-end">
                <label for="day_choice"> Jour à supprimer </label>
            </div>
            <div class="col-6 text-start">
                <?php
                // Choice what to remove
                $result = $mysqli->query("SELECT title FROM days");
                ?>
